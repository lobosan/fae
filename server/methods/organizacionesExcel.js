Meteor.methods({
    ...
    organizacionesExcel: function (organizaciones) {
        ...
        organizaciones.forEach(function (organizacion) {
            ...
            worksheet.writeToCell(row, 4, organizacion.nombreGrupo);
            ...
            worksheet.writeToCell(row, 10, organizacion.tiempoVidaGrupo);
            ...
            worksheet.writeToCell(row, 17, organizacion.capacidadTecnicaGrupo);
